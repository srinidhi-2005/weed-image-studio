          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-gray-400 hover:text-primary-600 hover:bg-primary-50 hover:scale-110 transition-all duration-300 shadow-md hover:shadow-lg"
                aria-label="GitHub"
              >
