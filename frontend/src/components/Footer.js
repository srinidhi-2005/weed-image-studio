...
function Footer() {
  return (
    <footer className="bg-gradient-to-br from-white to-primary-50/30 border-t-2 border-primary-200/50 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand Section */}
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-extrabold bg-gradient-to-r from-primary-600 to-primary-700 bg-clip-text text-transparent mb-4">AI Image Studio</h3>
            ...
            <div className="flex space-x-4">
              <a 
                href="https://github.com/srinidhi-2005/weed-image-studio.git" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-16 h-16 bg-white rounded-full flex items-center justify-center text-gray-400 hover:text-primary-600 hover:bg-primary-50 hover:scale-110 transition-all duration-300 shadow-md hover:shadow-lg"
                aria-label="GitHub"
              >
